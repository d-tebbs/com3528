...
class MiRoClient:
    ...
    def callback_light_sens(self, intensity):
        ...
        # For vehicle 3a, the LEFT sensor value is proportional to the LEFT
        ...
        speed_left  = 0.75 - f_left_intensity
        speed_right  = 0.75 - f_right_intensity
    ...
    def __init__(self):
        ...
        if not self.NODE_EXISTS:
            rospy.init_node("vehicle_3a", anonymous=True)
    ...
    def loop(self):
        ...
        print("MiRo implementation of Braitenberg Vehicle 3a, press CTRL+C to "
            + "halt...")
